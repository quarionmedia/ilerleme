    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (links && links.length > 0) {
                ...
                // Helper function to determine the video source type
                ...
                const playerSources = links.map(link => ({
                    src: link.url,
                    type: getSourceType(link.source), // Use the helper function
                ...
                links.forEach(link => {
                    if (link.subtitles && link.subtitles.length > 0) {
                        link.subtitles.forEach(sub => {
                            // This part does not need changes for SRT.
                            // Video.js will attempt to load both VTT and SRT.
                            // For best SRT compatibility, ensure your server sends
                            // 'Content-Type: application/x-subrip' for .srt files.
